                    ...
                    <table class="table table-bordernone">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="index.html" target="_blank">Delete</a>
                          </td>
                        </tr>
                        <tr>
                          <td>
                        ...
                        <tr>
                          <td>
                            <div class="media">
                              ...
                              <div class="media-body">
                                <a href="product-page.html"
                                  ><span>Sony Brand New Headphone</span></a
                                >
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="media">
                              ...
                              <div class="media-body">
                                <a href="product-page.html"
                                  ><span>Beautiful Golden Tree plant</span></a
                                >
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="media">
                              ...
                              <div class="media-body">
                                <a href="product-page.html"
                                  ><span>Being Human Branded T-Shirt </span></a
                                >
                              </div>
                            </div>
                          </td>
    ...
    return {
      ...
      distributedColumns: {
           options: {
            ...
            colors: [primary,primary,primary,secondary,primary,primary,primary,secondary,primary],
            plotOptions: {
              bar: {
                columnWidth: '30%',
                distributed: true,
          ...
          series: [{
            data: [21, 22, 10, 28, 16, 21, 13, 30,22]
          }],
